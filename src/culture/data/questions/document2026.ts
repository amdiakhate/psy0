...
export const document2026Questions: CultureQuestion[] = [
  ...
  choice(6, 'aerodromes', 'Combien de pistes physiques possède Paris-Charles de Gaulle ?', '4', ['2', '3', '5'], 'Selon les données du document vérifiées le 29 août 2026, Paris-CDG possède exactement quatre pistes physiques organisées en deux doublets parallèles.', { tags: ['QFU', 'hubs'], categories: ['air-france'], timeSensitive: true }),
  choice(7, 'aerodromes', 'Combien de QFU les quatre pistes de Paris-CDG représentent-elles ?', '8', ['4', '6', '10'], 'Selon les données du document vérifiées le 29 août 2026, chaque piste physique possède deux sens. Les quatre pistes donnent exactement huit QFU : 08L/26R, 08R/26L, 09L/27R et 09R/27L.', { tags: ['QFU', 'hubs'], categories: ['air-france'], timeSensitive: true }),
  ...
  choice(42, 'training', 'Quel est l’âge minimal pour obtenir une PPL(A) ?', '17 ans', ['16 ans', '18 ans', '21 ans'], 'L’âge minimal pour la délivrance d’une PPL(A) est de 17 ans.', { tags: ['PPL', 'licences'] }),
  choice(43, 'training', 'Combien d’heures de formation en vol faut-il au minimum dans le cursus standard PPL(A) ?', '45 h', ['35 h', '40 h', '50 h'], 'Le cursus standard PPL(A) prévoit au minimum 45 heures de formation en vol.', { tags: ['PPL', 'licences'] }),
  ...
  choice(45, 'training', 'Quel est l’âge minimal pour obtenir une SPL ?', '16 ans', ['14 ans', '15 ans', '17 ans'], 'L’âge minimal de délivrance d’une SPL est de 16 ans selon Part-SFCL.', { tags: ['SPL', 'licences'] }),
  ...
  choice(49, 'air-france', 'En quelle année Air France a-t-elle été créée ?', '1933', ['1919', '1930', '1945'], 'Air France est créée le 30 août 1933 par regroupement de plusieurs compagnies françaises.', { tags: ['histoire Air France'] }),
  ...
  choice(53, 'air-france', 'Combien de pilotes Air France sont indiqués au 31 décembre 2025 ?', '4 275', ['3 675', '4 875', '5 275'], 'Le document préparatoire, vérifié le 29 août 2026, indique exactement 4 275 pilotes Air France au 31 décembre 2025.', { tags: ['chiffres clés'], timeSensitive: true, difficulty: 2 }),
  choice(54, 'air-france', 'Combien d’avions Air France et HOP! comptent-elles au total au 31 décembre 2025 ?', '268', ['229', '248', '288'], 'Le document préparatoire, vérifié le 29 août 2026, indique exactement 268 appareils : 229 Air France hors HOP! et 39 HOP!.', { tags: ['flotte Air France'], categories: ['commercial-aviation'], timeSensitive: true, difficulty: 2 }),
  choice(55, 'air-france', 'Combien d’A350-900 Air France possède-t-elle au 31 décembre 2025 ?', '41', ['35', '38', '44'], 'Le document préparatoire, vérifié le 29 août 2026, indique exactement 41 Airbus A350-900 au 31 décembre 2025.', { tags: ['flotte Air France', 'A350'], categories: ['commercial-aviation'], timeSensitive: true }),
  ...
  choice(60, 'air-france', 'Dans combien de pays environ Air France dessert-elle des destinations à l’été 2026 ?', '73', ['63', '68', '78'], 'Le programme été 2026, vérifié le 29 août 2026, couvre exactement 73 pays.', { tags: ['destinations', 'réseau'], timeSensitive: true, difficulty: 2 }),
  ...
  choice(62, 'air-france', 'En quelle année SkyTeam a-t-elle été fondée ?', '2000', ['1997', '2004', '2008'], 'SkyTeam est fondée le 22 juin 2000 par quatre compagnies, dont Air France.', { tags: ['SkyTeam'], categories: ['commercial-aviation'] }),
  choice(63, 'commercial-aviation', 'Combien de membres actifs la page SkyTeam liste-t-elle au 29 août 2026 ?', '18', ['16', '20', '22'], 'La page officielle SkyTeam, vérifiée le 29 août 2026, liste exactement 18 membres actifs, Aeroflot étant indiqué comme suspendu.', { tags: ['SkyTeam'], categories: ['air-france'], timeSensitive: true, difficulty: 2, highYield: false }),
  choice(64, 'air-france', 'En quelle année le groupe Air France-KLM est-il né ?', '2004', ['2000', '2007', '2010'], 'Le rapprochement d’Air France et KLM donne naissance au groupe en 2004, les deux marques étant conservées.', { tags: ['histoire Air France', 'organisation'], categories: ['commercial-aviation'] }),
  ...
  choice(66, 'general-aviation', 'En quelle année les vols commerciaux du Concorde ont-ils commencé ?', '1976', ['1969', '1973', '1978'], 'Air France et British Airways commencent les vols commerciaux du Concorde en 1976.', { tags: ['Concorde', 'histoire'] }),
  choice(67, 'general-aviation', 'En quelle année Air France a-t-elle arrêté les vols commerciaux du Concorde ?', '2003', ['2000', '2001', '2005'], 'Le dernier vol commercial du Concorde chez Air France a lieu le 31 mai 2003.', { tags: ['Concorde', 'histoire'] }),
  ...
  choice(71, 'general-aviation', 'En quelle année Youri Gagarine devient-il le premier humain dans l’espace ?', '1961', ['1957', '1963', '1969'], 'Le vol de Vostok 1 a lieu le 12 avril 1961.', { tags: ['espace'], highYield: false }),
