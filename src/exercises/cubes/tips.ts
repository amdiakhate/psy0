...
export const tips: Tips = {
  method: [
    ...
    'Le RETOURNEMENT (touche R) est un test de chiralité : si une pièce ne peut coller qu’en miroir, c’est qu’elle t’a été donnée retournée. Vérifie toujours ce qui touche l’arête commune avec une face voisine connue.',
  ...
  traps: [
    ...
    'Oublier de retourner une pièce présentée en miroir (ou en retourner une qui ne devait pas l’être) : c’est le piège explicite de l’énoncé officiel, « les faces peuvent être retournées ».',
